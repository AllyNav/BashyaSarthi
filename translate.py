...
def main():
    pdf_path = "Y:/My projects for Github/Translate pdf/PDF to Convert/inputfile.pdf"
    ...
    # Example usage
    output_string = trans
    file_path = "Y:/My projects for Github/Translate pdf/Translate and output/output.txt"
